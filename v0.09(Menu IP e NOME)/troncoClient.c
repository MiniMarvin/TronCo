...
int menu(){
   ...
   while(running){
	   ...
	   al_draw_text(font_small, al_map_rgb(255,255,255), WIDTH/2, 350,ALLEGRO_ALIGN_CENTRE, "Jogar");
	   al_draw_text(font_small, al_map_rgb(255,255,255), WIDTH/2, 550,ALLEGRO_ALIGN_CENTRE, "Ranking");
	   al_draw_text(font_small, al_map_rgb(255,255,255), WIDTH/2, 750,ALLEGRO_ALIGN_CENTRE, "Sair");
	   
	   //cursor
	   al_draw_circle(550, 175  + 200*(cursorPos + 1), 20, al_map_rgb(255,255,255), 4);
	   al_flip_display();
